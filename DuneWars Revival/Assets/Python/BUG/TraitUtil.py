...
def init():
	...
	addTrait("ABOMINATION", game.getSymbolID(FontSymbols.ANGRY_POP_CHAR), "Art/Interface/Buttons/TechTree/mind_training.dds")	
	addTrait("AGGRESSIVE", game.getSymbolID(FontSymbols.STRENGTH_CHAR), ",Art/Interface/Buttons/Promotions/Combat1.dds,Art/Interface/Buttons/dunepromoatlas1.dds,8,3")
	...
	addTrait("FINANCIAL", game.getSymbolID(FontSymbols.TRADE_CHAR), "Art/Interface/Buttons/TechTree/Banking.dds")
	addTrait("IMPERIALIST", game.getSymbolID(FontSymbols.OCCUPATION_CHAR), "Art/Interface/Buttons/Actions/FoundCity.dds")
	addTrait("INDUSTRIOUS", game.getSymbolID(FontSymbols.SILVER_STAR_CHAR), "Art/Interface/Buttons/TechTree/Industrialism.dds")
	addTrait("MECHANIZED", game.getSymbolID(FontSymbols.POWER_CHAR), "Art/Interface/Buttons/TechTree/desert_rovers.dds")
	...
	addTrait("PROTECTIVE", game.getSymbolID(FontSymbols.DEFENSE_CHAR), ",Art/Interface/Buttons/Actions/Fortify.dds")
	addTrait("SPIRITUAL", game.getSymbolID(FontSymbols.RELIGION_CHAR), "Art/Interface/Buttons/TechTree/Meditation.dds")
	addTrait("POISONED", game.getSymbolID(FontSymbols.EATEN_FOOD_CHAR), "")
	addTrait("TECHMAN", gc.getYieldInfo(YieldTypes.YIELD_PRODUCTION).getChar(), "Art/Interface/MainScreen/CityScreen/sp_engr.dds")
	addTrait("FREMEN", gc.getYieldInfo(YieldTypes.YIELD_FOOD).getChar(), "Art/Terrain/Resources/imported_goods/fremen_water_debt.dds")
