	...
	def placeRequires(self):
		...
		for iBuild in range(gc.getNumBuildInfos()):
			if (gc.getBuildInfo(iBuild).getImprovement() == self.iImprovement):
                ...
                #!M!
		iCiv = -1
		if self.iImprovement == gc.getInfoTypeForString("IMPROVEMENT_TOWN_RICHESE") or \
                   self.iImprovement == gc.getInfoTypeForString("IMPROVEMENT_MIRROR"):
			iCiv = gc.getInfoTypeForString("CIVILIZATION_RICHESE")
		if self.iImprovement == gc.getInfoTypeForString("IMPROVEMENT_TRADING_POST") or \
                   self.iImprovement == gc.getInfoTypeForString("IMPROVEMENT_SIETCH1") or \
				   self.iImprovement == gc.getInfoTypeForString("IMPROVEMENT_SIETCH2") or \
				   self.iImprovement == gc.getInfoTypeForString("IMPROVEMENT_SIETCH3") or \
				   self.iImprovement == gc.getInfoTypeForString("IMPROVEMENT_SIETCH4"):
			iCiv = gc.getInfoTypeForString("CIVILIZATION_FREMEN")
		if (iCiv > -1):
			...
			screen.attachLabel(panelName, "", u"(Only allowed for)")
